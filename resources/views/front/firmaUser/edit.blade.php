...
@section('content')
   ...
   <div class="container">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <form action="{{ route('firmaUser.update',['id'=>$data['id']]) }}" onsubmit="return validateForm()" method="POST" enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="mt-3">
                            ...
                            <div>
                                <div class="form-check form-check-inline">
                                    ...
                                    @if (strpos($data['kantons'], 'Aargau') !== false) checked @endif required>
                                ...
                                <div class="form-check form-check-inline">
                                    ...
                                    @if (strpos($data['kantons'], 'Zug') !== false) checked @endif required>
                                ...
                                <div class="form-check form-check-inline">
                                    ...
                                    @if (strpos($data['kantons'], 'Zürich') !== false) checked @endif required>
