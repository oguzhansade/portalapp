...
Route::group(['namespace' => 'front', 'middleware' => ['auth']], function () {
    ...
    Route::group(['namespace' => 'offerList', 'as' => 'offerList.','prefix' => 'offerList'], function () {
        ...
        Route::post('/statusChanger/{id}', [App\Http\Controllers\front\offerList\indexController::class, 'statusChanger'])->name('statusChanger');
        Route::get('/statusChanger/{id}', [App\Http\Controllers\front\offerList\indexController::class, 'statusChanger'])->name('statusChanger');
