...
@section('content')
    ...
    <div class="container">
        ...
        <div class="row d-flex justify-content-start mt-5">
            <div class="col-lg-3 col-md-4 col-sm-4 p-1">
                <a href="{{ route('offerList.index') }}" class="hvr-grow text-decoration-none">
                    <div class="card b-shadow" style="width: 18rem;border:0;border-radius:35px;">
                        ...
                        <div class="card-body bg-primary " style="border-bottom-left-radius:35px;border-bottom-right-radius:35px;">
            ...
            <div class="col-lg-3 col-md-4 col-sm-4 p-1">
                <a href="{{ route('firma.index') }}" class="hvr-grow text-decoration-none">
                    <div class="card b-shadow" style="width: 18rem;border:0;border-radius:35px;">
            ...
            <div class="col-lg-3 col-md-4 col-sm-4 p-1">
                <a href="{{ route('firma.create') }}" class="hvr-grow text-decoration-none">
                    <div class="card b-shadow" style="width: 18rem;border:0;border-radius:35px;">
