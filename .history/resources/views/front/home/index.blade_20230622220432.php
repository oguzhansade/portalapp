    ...
    <div class="container-fluid">
        <div class="row d-flex justify-content-start">
            <div class="col-lg-3 col-md-6 col-sm-6 p-1">
                <a href="{{ route('workerPanel.task',  ['id' => Auth::id()]) }}" class="hvr-grow">
                    <div class="card b-shadow" style="width: 18rem;border:0;border-radius:35px;">
                        <span class="notify-badge">{{ $gorevSayisi }}</span>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 p-1">
                <a href="{{ route('workerPanel.profileEdit',['userId' => Auth::id()]) }}" class="hvr-grow ">
                    <div class="card b-shadow" style="width: 18rem;border:0;border-radius:35px;">
