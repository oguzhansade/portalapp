...
class FormCraftController extends Controller
{
    ...
    public function handlePrivatumzugForm(Request $request)
    {
        ...
        $filePath = storage_path('app/public/schennlanTest.txt'); // Dosyanın tam yolu
    ...
    public function handleFirmenForm(Request $request)
    {
        ...
        FirmaSelector::FirmaSelector($firmenId,'Firmen');
    ...
    public function handleKontaktForm(Request $request)
    {
        ...
        FirmaSelector::FirmaSelector($kontaktId,'Kontakt');
    ...
    public function mailTester()
    {
        ...
        $emailData = [
            'sub' => 'Camdalio Portal App Offerte',
            'from' => 'oguzhansade1@gmail.com',
            'companyName' => 'Firma Adı',
            'email' => 'sadeyww@gmail.com'
        ];
        Mail::to('sadeyww@gmail.com')->send(new OfferMail($emailData));
        return response()->json(['message' => 'Mail Fonksiyonu Çalıştı']);
    }
}
