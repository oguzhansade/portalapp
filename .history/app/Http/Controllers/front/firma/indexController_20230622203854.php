...
class indexController extends Controller
{
    ...
    public function data()
    {
        ...
        {
            return '
            <a class="btn btn-sm  btn-edit" href="'.route('firma.edit',['id'=>$table->id]).'">Edit</a> <span class="text-primary">|</span>
            <a class="btn btn-sm  btn-danger"  href="'.route('firma.edit',['id'=>$table->id]).'">Delete</a>';
        })
