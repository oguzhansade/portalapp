...
class indexController extends Controller
{
    ...
    public function data(Request $request)
    {
        ...
        ->addColumn('status', function ($array) {
                ...
                {
                    return sprintf('<button class="btn btn-sm btn-warning " onClick="statusChanger(%d, \'%s\')">Pasif</button>', $array['id'], $array['type']);
                }
                else {
                    return sprintf('<button class="btn btn-sm btn-success " onClick="statusChanger(%d, \'%s\')">Aktif</button>', $array['id'], $array['type']);
                }
        ...
        {
            return '<a class="btn  btn-detail" href="' . route('offerList.detail', ['id' => $array['id'], 'type' => $array['type']]) . '">Detail</a>';
        })
