    ...
    public function data(Request $request)
    {
        ...
        ->addColumn('option', function ($array) {
            switch ($array['type']) {
                ...
                {
                    return '
                            <button  class="btn btn-sm btn-warning payButton" onClick="statusChanger('.$array->id.')">Pasif</button>';
                }
                else {
                    return '
                    <button class="btn btn-sm btn-success payButton" onClick="statusChanger('.$array->id.')">Aktif</button>';
                }
                    break;
            }
        })
