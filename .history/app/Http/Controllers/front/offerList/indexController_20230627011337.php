    ...
    public function data(Request $request)
    {
        ...
        ->addColumn('status', function ($array) {
            switch ($array['type']) {
                ...
                {
                    return '
                            <button  class="btn btn-sm btn-warning payButton" onClick="statusChanger('.$array['offerId'].')">Pasif</button>';
                }
                else {
                    return '
                    <button class="btn btn-sm btn-success payButton" onClick="statusChanger('.$array['offerId'].')">Aktif</button>';
                }
                    break;
            }
        })
        ...
        ->addColumn('option',function($array) 
        {
            switch ($array['type']) {
                ...
                return '
                <a class="btn btn-sm  btn-primary" href="' . route('firma.detail', ['id' => $array['id']]) . '"><i class="feather feather-eye" ></i></a> <span class="text-primary">|</span>
                <a class="btn btn-sm  btn-edit" href="' . route('firma.edit', ['id' => $array['id']]) . '"><i class="feather feather-edit" ></i></a> <span class="text-primary">|</span>
                <a class="btn btn-sm  btn-danger"  href="' . route('firma.delete', ['id' => $array['id']]) . '"><i class="feather feather-trash-2" ></i></a>';
                    break;
            }
        })
