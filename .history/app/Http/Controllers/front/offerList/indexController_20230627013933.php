...
class indexController extends Controller
{
    ...
    public function data(Request $request)
    {
        ...
        ->addColumn('status', function ($array) {
                ...
                {
                    return sprintf('<button class="btn btn-sm btn-warning payButton" onClick="statusChanger(%d, \'%s\')">Pasif</button>', $array['offerId'], $array['type']);
                }
                else {
                    return sprintf('<button class="btn btn-sm btn-success payButton" onClick="statusChanger(%d, \'%s\')">Aktif</button>', $array['offerId'], $array['type']);
                }
