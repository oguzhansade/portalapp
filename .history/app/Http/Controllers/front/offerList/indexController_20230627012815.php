...
class indexController extends Controller
{
    ...
    public function data(Request $request)
    {
        ...
        ->addColumn('status', function ($array) {
                ...
                {
                    return '<button class="btn btn-sm btn-warning payButton" onClick="statusChanger('.$array['offerId'].', "'.$array['type'].'")">Pasif</button>';
                }
                else {
                    return '<button class="btn btn-sm btn-warning payButton" onClick="statusChanger('.$array['offerId'].', "'.$array['type'].'")">Aktif</button>';
                }
