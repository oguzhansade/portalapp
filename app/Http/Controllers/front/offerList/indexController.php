...
class indexController extends Controller
{
    ...
    {
        return view('front.kunden.index');
    }
    ...
    public function data2(Request $request)
    {
        ...
        if ($tableData) {
            foreach ($tableData as $k => $v) {
                ...
                $array[$i]["offerId"] = $v->entryId;
                $array[$i]["customerName"] = $v->fullname;
                $array[$i]["email"] = $v->email;
                $array[$i]["telefon"] = $v->telefon;
                $array[$i]["type"] = $v->type;
                $array[$i]["vonadresse"] = $v->von1.' '.$v->von2;
                $array[$i]["nachadresse"] = $v->nach1.' '.$v->nach2;
                $array[$i]["zimmer"] = $v->zimmer;
                $array[$i]["created_at"] = date('d-m-Y', strtotime($v->created_at));
                $array[$i]["status"] = $v->status;
                $array[$i]["canceled"]= $v->canceled;
        ...
        if ($table2Data) {
            foreach ($table2Data as $k => $v) {
                ...
                $array[$i]["telefon"] = $v->telefon;
                $array[$i]["type"] = $v->type;
                $array[$i]["vonadresse"] = $v->address;
                $array[$i]["nachadresse"] = $v->address;
                $array[$i]["zimmer"] = $v->anzahlZimmer;
                $array[$i]["created_at"] = date('d-m-Y', strtotime($v->created_at));
                $array[$i]["status"] = $v->status;
                $array[$i]["canceled"]= $v->canceled;
        ...
        if ($table3Data) {
            foreach ($table3Data as $k => $v) {
                ...
                $array[$i]["telefon"] = $v->telefon;
                $array[$i]["type"] = $v->type;
                $array[$i]["vonadresse"] = $v->vonStrasse.' '.$v->vonPlzOrt;
                $array[$i]["nachadresse"] = $v->nachStrasse.' '.$v->nachPlzOrt;
                $array[$i]["zimmer"] = $v->anzahlZimmer;
                $array[$i]["created_at"] = date('d-m-Y', strtotime($v->created_at));
                $array[$i]["status"] = $v->status;
                $array[$i]["canceled"]= $v->canceled;
            ...
            case 'Schnellanfrage':
                ...
                if ($entry['status'] == 'Aktif') {
                    ...
                    foreach ($getOFirmas as $getOFirma) {
                        ...
                        // {
                        //     $emailData = [
                        //         'sub' => 'Das Angebot Nummer'.' '.$offerId.' '.'wurde auf Kundenwunsch storniert',
            ...
            case 'Schnellanfrage':
                ...
                if ($entry['canceled'] == 0) {
                    ...
                    foreach ($getOFirmas as $getOFirma) {
                        ...
                        {
                            $emailData = [
                                'sub' => 'Das Angebot mit der Nummer'.' '.$form['entryId'].' '.'wurde auf Kundenwunsch wieder aktiviert',
                                'from' => 'info@umzugspreisvergleich.ch',
                                'companyName' => 'Umzugspreisvergleich.ch',
                                'offer' => $form,
                                'type' => $type,
